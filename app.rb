...
get '/api/v1/timesheetDocument' do
	timesheetDocument = get_data "https://thrillistmediagroup.atlassian.net/secure/TempoTeamBoard!timesheet.jspa?v=1&periodType=BILLING&periodView=PERIOD&period=0716"
	content_type :json
